	...
	<body>
		...
		<div class="container">  
			...
			<div class="py-3 text-center">
				...
				<h2>Envia E-mail</h2>
				<p class="lead">Seu site de envio de e-mails favorito!</p>
			</div>
      		...
      		<div class="row">
      			<div class="col-md-12">
					...
					<div class="card-body font-weight-bold">
						...
						<form action="Processo/envia_email.php" method="post">
							<div class="form-group">
								<label for="para">Para</label>
								<input type="email" class="form-control" id="para" name="email" placeholder="joao@dominio.com.br">
							</div>
